...
public class CameraAssistCenter extends CommandBase implements PIDSource, PIDOutput
{
  ...
  private static final double kP = 0.01; //Before .06
  ...
  private static Timer timer; // time in seconds
    ...
    public void pidWrite(double pidSpeed) {
        drivetrain.setMecanum(-1, 0, pidSpeed); // Go Left negative, right is positive
    }
