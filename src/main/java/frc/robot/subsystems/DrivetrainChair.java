...
public class DrivetrainChair extends Subsystem {
  ...
  public void init(){
    _frontLeftMain = new TalonSRX(RobotMap.frontLeftChair);
    ...
    _frontRightMain =  new TalonSRX(RobotMap.frontRightChair);
    ...
    _backLeftMain = new TalonSRX(RobotMap.backLeftChair);
    ...
    _backRightMain = new TalonSRX(RobotMap.backRightChair);
  ...
  /*public void switchSolenoid(){
    if (isSwitched){
      _solenoid.set(Value.kReverse, _solenoid.set(Value.kForward));
      isSwitched = true;
    }
  }*/
  ...
  {
    return _frontLeftMain.getMotorOutputPercent();
  }

  @Override
  public void initDefaultCommand() {
    setDefaultCommand(new OperateMecanumDrive());
    //setDefaultCommand(new CameraDriveTest());
  }
}
